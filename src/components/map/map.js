...
const topo = L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token=pk.eyJ1IjoibWFyaWdlcnIiLCJhIjoiY2p1dnVyMmk1MDJ5aDN5bWxvYXBra3Y0aSJ9.MXrMvOH0sHu_rDJBZUmkIQ', {
...
const initBounds = L.latLngBounds(L.latLng(56.96162003401705, 13.088924617411951),
  L.latLng(58.147842301716636, 15.602056619493775));
...
function initMap() {
  if (localStorageKeyExists('top1000Jkpg')) {
    const response = getFromLocalStorage('top1000Jkpg');
...
export {
  initMap, map, sidebar, geojsonLayer, updateLegend, emptyMap, updateGeojsonLayer, setViewOpenPopup,
}; // vlocationMarker,
