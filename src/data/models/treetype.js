...
function trees() {
  return [{
    family: 'zzzz', matchWith: /XXXXX/i, id: 'Alla', querytext: 'Tradslag is not null', label: 'Alla', color: '',
  },
  {
...
function removeDuplicateTrees(treeArray) {
  ...
  finalFilteredTrees.unshift({
    family: 'zzzz', matchWith: /XXXXX/i, id: 'Alla', querytext: 'Tradslag is not null', label: 'Alla',
  });
...
export {
  trees, getTreetypeQueryText, getTrees, removeDuplicateTrees,
};
